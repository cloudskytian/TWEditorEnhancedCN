...
public class DBList extends DBElementValue implements Cloneable {
	...
	public String getString(String label) throws DBException {
	...
	public void setString(String label, String value) throws DBException {
		DBElement element = getElement(label);
		if (element != null) {
			int fieldType = element.getType();
			if (fieldType == 10) {
	...
	public int getInteger(String label) throws DBException {
		DBElement element = getElement(label);
		int value;
		if (element != null) {
			int fieldType = element.getType();
	...
	public void setInteger(String label, int value) throws DBException {
		setInteger(label, value, 5);
	}

	public void setInteger(String label, int value, int type) throws DBException {
		DBElement element = getElement(label);
		if (element != null) {
			int fieldType = element.getType();
			if (fieldType == 0) {
	...
	public float getFloat(String label) throws DBException {
		DBElement element = getElement(label);
		float value;
		if (element != null) {
			int fieldType = element.getType();
	...
	public void setFloat(String label, float value) throws DBException {
		DBElement element = getElement(label);
		if (element != null) {
			int fieldType = element.getType();
			if (fieldType == 8)

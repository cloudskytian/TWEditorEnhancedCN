...
public class StatsPanel extends JPanel {
	private static final String[][] fieldNames = { { "等级", "生命值", "青铜天赋" }, { "经验值", "耐力", "白银天赋" },
			{ "奥伦币", "毒质", "黄金天赋" } };
	private static final String[][] databaseNames = { { "ExpLevel", "CurrentHitPoints", "TalentBronze" },
			{ "Experience", "CurrentEndurance", "TalentSilver" }, { "Gold", "CurrentToxicity", "TalentGold" } };

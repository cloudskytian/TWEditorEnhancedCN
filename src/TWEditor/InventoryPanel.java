...
public class InventoryPanel extends JPanel implements ActionListener {
	private static final String[] categories = { "炸弹", "书籍", "饮料", "食物", "宝石", "油品", "原料", "戒指", "护身符", "药水", "任务",
			"武器升级", "其他" };
	private static final int[][] categoryMappings = { { 20, 7 }, { 21, 8 }, { 22, 9 }, { 23, 7 }, { 30, 1 }, { 32, 4 },
			{ 33, 6 }, { 34, 11 }, { 37, 8 }, { 38, 7 }, { 40, 10 }, { 44, 3 }, { 45, 12 }, { 46, 5 }, { 47, 0 },
			{ 48, 2 } };
	private static final String[] substanceNames = { "Vitriol", "Rebis", "Aether", "Quebirth", "Hydragenum",
			"Vermilion", "Albedo", "Nigredo", "Rubedo" };
	...
	public InventoryPanel() {
		...
		availPane.add(new JLabel("可用物品", 0), "North");
	...
	private void addSelectedItem() throws DBException, IOException {
		...
		if (questItem == 0) {
			...
			if (!foundSlot) {
				JOptionPane.showMessageDialog(this, "没有可用的物品格位", "物品已满", 0);
				return;
			}
		}

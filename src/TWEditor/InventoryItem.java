...
public class InventoryItem implements Comparable<InventoryItem> {
	...
	public InventoryItem(String name, DBElement element) throws DBException {
		this.name = name;
	...
	public boolean equals(Object obj) {
		boolean equal = false;
		if ((obj != null) && ((obj instanceof InventoryItem)) && (((InventoryItem) obj).getName().equals(this.name))

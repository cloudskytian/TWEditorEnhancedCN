...
public class LocalizedString extends DBElementValue implements Cloneable {
	...
	public Object clone() {
		...
		for (int i = 0; i < count; i++) {
			clonedString.substringList
					.add((LocalizedSubstring) ((LocalizedSubstring) this.substringList.get(i)).clone());
		}
		return clonedObject;
	}
}